    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $rows = $employees->values()->map(function (Employee $employee, int $index) use ($progressMap, $latestPlanMap, $levels, $statuses) {
            ...
            return [
                ...
                'manager_functional' => $employee->manager_functional ?? $employee->managerFunctional?->name,
                'manager_operational' => $employee->manager_operational ?? $employee->managerOperational?->name,
