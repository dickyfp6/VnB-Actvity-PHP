    ...
    <div id="sidebar" class="sidebar">
        ...
        <nav>
            ...
            <div class="nav-link dashboard-parent" id="dashboardParent" title="Dashboard">
                ...
                <span>Dashboard</span>
                <i id="dashboardExpandIcon" class="fas fa-chevron-down ml-auto text-sm" style="opacity:0.8; transform: {{ $isDashboardOpen ? 'rotate(180deg)' : 'rotate(0deg)' }};"></i>
            </div>
            <div id="dashboardSubmenu" style="display: {{ $isDashboardOpen ? 'block' : 'none' }}; margin-left: 0.5rem; margin-top: 0.35rem; margin-bottom: 0.35rem;">
                <a href="/dashboard/vnb" class="nav-link ml-2 {{ request()->is('/') || request()->is('dashboard/vnb*') ? 'active' : '' }}" title="Dashboard VnB" style="padding-left: 2rem;">
                    <i class="fas fa-tasks w-4 flex-shrink-0"></i>
                    <span>VnB</span>
                </a>
                <a href="/dashboard/star" class="nav-link ml-2 {{ request()->is('dashboard/star*') ? 'active' : '' }}" title="Dashboard STAR" style="padding-left: 2rem;">
