...
function renderTable() {
    ...
    if (!allEmployees.length) {
        ...
        tbody.innerHTML = `<tr><td colspan="13" class="text-center py-4 text-gray-400">${emptyText}</td></tr>`;
        return;
    }
    ...
    if (!filteredData.length) {
        tbody.innerHTML = `<tr><td colspan="13" class="text-center py-4 text-gray-400">Tidak ada data yang cocok dengan pencarian "${escapeHtml(globalSearchQuery)}"</td></tr>`;
        return;
    }
