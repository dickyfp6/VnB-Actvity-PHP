@extends('layouts.app')
@section('title','VnB Framework')
@section('page_title','VnB Framework')
@section('page_subtitle','Bangun behaviour, career stage, dan peta golongan dalam satu ruang kerja yang ringkas.')
@section('content')
<style>
  .fw-card {
...
{{-- Inline Setup Editor (behaviour + career stage + golongan pills) --}}
