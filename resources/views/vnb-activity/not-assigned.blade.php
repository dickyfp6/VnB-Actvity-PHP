...
@section('title', 'VnB Activity - Belum Ditugaskan')
@section('page_title', 'VnB Activity')
@section('page_subtitle', 'Modul aktivitas belum tersedia untuk akun Anda saat ini.')
