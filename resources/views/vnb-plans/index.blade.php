        ...
        for (let integIdx = 0; integIdx < integrationList.length; integIdx++) {
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 w-2/5 align-top">
                    <div class="text-xs text-gray-700 bg-gray-50 rounded px-3 py-2">${escapeHtml(integration).replace(/\n/g, '<br>')}</div>
                </td>
                <td class="px-4 py-3 w-2/5 align-top">
            ...
            <tr class="hover:bg-gray-50">
                ...
                // Skip rendering if this integration has no rencana and not editing
                if (!isThisIntegrationSaved && !isThisIntegrationEditing) {
                    continue; // Skip this integration row
                }
