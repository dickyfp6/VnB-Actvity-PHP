...
<div class="px-4 space-y-4">
  ...
  <div class="flex gap-2 border-b border-gray-200">
    <button id="tab-vnb-plans" onclick="switchTab('vnb_plans')" class="px-4 py-2 font-medium transition-colors" style="color: #144600; border-bottom: 2px solid #144600;">
    ...
    <button id="tab-vnb-activities" onclick="switchTab('vnb_activities')" class="px-4 py-2 font-medium transition-colors text-gray-500 hover:text-gray-700">
...
function switchTab(tab) {
  ...
  // Update tab buttons
  document.getElementById('tab-vnb-plans').style.color = tab === 'vnb_plans' ? '#144600' : '#999999';
  document.getElementById('tab-vnb-plans').style.borderBottom = tab === 'vnb_plans' ? '2px solid #144600' : 'none';
  document.getElementById('tab-vnb-activities').style.color = tab === 'vnb_activities' ? '#144600' : '#999999';
  document.getElementById('tab-vnb-activities').style.borderBottom = tab === 'vnb_activities' ? '2px solid #144600' : 'none';
