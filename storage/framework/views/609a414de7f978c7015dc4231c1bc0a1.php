...
<?php $__env->startSection('title', 'HRIS - VnB Platform'); ?>
...
<div class="px-4 space-y-4">
    <div class="flex items-center justify-between gap-3">
        ...
        <button onclick="loadHrisData()" class="text-white px-4 py-2 rounded-lg text-sm" style="background-color: #144600;" onmouseover="this.style.backgroundColor='#37AA05'" onmouseout="this.style.backgroundColor='#144600'">
