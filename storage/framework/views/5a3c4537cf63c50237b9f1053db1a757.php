...
<?php $__env->startSection('title', 'STAR Approval Review - VnB Platform'); ?>
<?php $__env->startSection('page_title', 'STAR Approval Review'); ?>
<?php $__env->startSection('page_subtitle', 'Review pengajuan STAR dalam satu halaman sederhana.'); ?>
...
<div class="max-w-4xl mx-auto px-4 space-y-6">
	<div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
		...
		<div class="flex items-start justify-between gap-4">
			...
			<a href="<?php echo e(route('star.star-approval')); ?>" class="rounded-full border border-gray-200 px-3 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50">Kembali</a>
		</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USERR\Documents\0. Magang\Wismilak\VnB WebApp PHP\resources\views/star/approval-review.blade.php ENDPATH**/ ?>