...
<?php $__env->startSection('page_title','Master Data'); ?>
<?php $__env->startSection('page_subtitle','Kelola master referensi seperti perusahaan, divisi, jabatan, penempatan, dan golongan.'); ?>
...
<div class="px-4">
  ...
  <div class="flex space-x-1 mb-6 bg-gray-100 p-1 rounded-lg w-fit">
    ...
    ?>
    <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USERR\Documents\0. Magang\Wismilak\VnB WebApp PHP\resources\views\master-data\index.blade.php ENDPATH**/ ?>