...
<div class="space-y-6 max-w-6xl mx-auto px-4">
	<div class="flex items-center justify-between gap-4">
		...
		<a id="add-recognition-btn" href="<?php echo e(route('star.recognition.create')); ?>" class="inline-flex items-center gap-2 rounded-full bg-[#144600] px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:opacity-90">
