...
<body class="bg-gradient-to-br from-gray-50 via-white to-gray-100 flex flex-col min-h-screen text-gray-900 font-sans">
    ...
    <div id="sidebar" class="sidebar">
        ...
        <nav>
            ...
            <?php if(in_array($activeRole, ['intercomm', 'pcx_manager', 'manager'])): ?>
            <a href="/employees" class="nav-link <?php echo e(request()->is('employees*') ? 'active' : ''); ?>" title="Manage Employee">
                <i class="fas fa-user-graduate w-5 flex-shrink-0"></i>
                <span>Employees</span>
            </a>
            <?php endif; ?>

            <?php if($activeRole === 'pcx_manager'): ?>
            ...
            <?php if(in_array($activeRole, ['intercomm', 'pcx_manager'])): ?>
            <a href="/managers" class="nav-link <?php echo e(request()->is('managers*') ? 'active' : ''); ?>" title="Manage Manager">
            ...
            <a href="/star/schema" class="nav-link <?php echo e(request()->is('star/schema*') ? 'active' : ''); ?>" title="STAR Schema">
            ...
            <a href="/star/approval" class="nav-link <?php echo e(request()->is('star/approval*') ? 'active' : ''); ?>" title="Approval">
            ...
            <a href="/vnb/activity" class="nav-link <?php echo e(request()->is('vnb/activity*') ? 'active' : ''); ?>" title="VnB Activity">
            ...
            <?php if(in_array($activeRole, ['intercomm', 'pcx_manager'])): ?>
            <a href="/vnb/participants" class="nav-link <?php echo e(request()->is('vnb/participants*') ? 'active' : ''); ?>" title="Participants">
            ...
            <a href="/vnb/approval" class="nav-link <?php echo e(request()->is('vnb/approval*') ? 'active' : ''); ?>" title="Activity Approval">
            ...
            <a href="/manager/employees" class="nav-link <?php echo e(request()->is('manager/employees*') ? 'active' : ''); ?>" title="Kelola Employee">
                <i class="fas fa-user-graduate w-5 flex-shrink-0"></i>
            ...
            <div id="topProfileMenuWrapper" class="relative">
                ...
                <div id="topProfileMenu" class="top-profile-menu hidden">
                    <div class="px-2 pb-2 mb-2 border-b border-gray-100">
                        ...
                        <p class="text-[11px] text-gray-500 mt-0.5">Role aktif: <?php echo e(str_replace('_',' ',$activeRole ?? '-')); ?></p>
