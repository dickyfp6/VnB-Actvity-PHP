...
<body class="bg-gradient-to-br from-gray-50 via-white to-gray-100 flex flex-col min-h-screen text-gray-900 font-sans">
    ...
    <div id="sidebar" class="sidebar">
        ...
        <nav>
            ...
            <a href="/star" class="nav-link <?php echo e(request()->is('star*') ? 'active' : ''); ?>" title="STAR">
            ...
            <?php if($activeRole === 'direktur_utama'): ?>
            <a href="/my-account/profile" class="nav-link <?php echo e(request()->is('my-account/profile*') ? 'active' : ''); ?>" title="Profil Saya">
