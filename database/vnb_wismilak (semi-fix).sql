...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Apr 2026 pada 17.53
...
(1, '5026221011', 'Employee', '2026-04-01', '2026-04-07', 'PT Gawih Djaja', 5, 4, 2, 'Bengkulu', 'Staff/Supervisor', 'OS', 'employee@vnb.id', '082123456789', 1, NULL, '2026-04-07', '2027-04-06', 'active', 'active', NULL, NULL, NULL, NULL, '2026-04-07 09:40:31', '2026-04-07 09:48:50', NULL),
(2, '5026221078', 'Ahnaf Fathan', '2026-04-01', '2026-04-07', 'PT Gelora Djaja', 6, 12, 5, 'Bandung', 'Staff/Supervisor', 'PKWTT', 'fathan@vnb.id', '081234567890', 2, NULL, '2026-04-07', '2027-04-06', 'active', 'active', NULL, NULL, NULL, NULL, '2026-04-07 09:49:34', '2026-04-07 09:49:34', NULL),
(3, '5026221063', 'Regina Dwi', '2026-04-01', '2026-04-07', 'PT Wismilak Inti Makmur, Tbk', 6, 5, 3, 'Banjarmasin', 'Manager', 'PKWTT', 'rere@vnb.id', '082123456788', 2, 1, '2026-04-07', '2027-04-06', 'active', 'active', NULL, NULL, NULL, NULL, '2026-04-07 09:49:55', '2026-04-07 09:49:55', NULL);
...
(1, 'Manager', 'manager@vnb.id', '5026221022', 'PT Gawih Djaja', 'Information and Technology', 'active', 11, '2026-04-07 09:39:49', '2026-04-07 09:39:49', NULL),
(2, 'Dicky Febri Primadhani', 'dicky@vnb.id', '5026221036', 'PT Wismilak Inti Makmur, Tbk', 'Information and Technology', 'active', 13, '2026-04-07 09:46:35', '2026-04-07 09:46:35', NULL);
...
(6, 'Admin User', 'admin@vnb.id', '2026-04-07 09:04:01', '$2y$12$GeY/.4/ad2U0c./SMbvfwuXeGfON1V4fldLsMZy7OcNP6mC9LyIXK', NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2026-04-07 09:03:00', '2026-04-07 09:04:01'),
(8, 'PCX Manager', 'pcx@vnb.id', '2026-04-07 09:04:02', '$2y$12$kUs9CvCf2UudHUB8cLdNu.uQ8yKyrJRoa7oqtdVx3bSNpdw7bDJEK', NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2026-04-07 09:03:01', '2026-04-07 09:04:02'),
(9, 'Intercomm User', 'intercomm@vnb.id', '2026-04-07 09:04:02', '$2y$12$WVDMO.ikD7iLIw0mT8uPJei.ZFwhiruglv6KQs.DKH.brcPh0i0aK', NULL, NULL, NULL, NULL, 'active', NULL, NULL, '2026-04-07 09:03:01', '2026-04-07 09:04:02'),
(11, 'Manager', 'manager@vnb.id', NULL, '$2y$12$dB5wLaWoLZs/dKPuTsgirenumQlaX6iHx11MJe0ZSnYg.fv9alip.', 'eyJpdiI6Ikg3bkNRWTl6a2hGMGQwYWViT3lLTWc9PSIsInZhbHVlIjoiMEFSTVNENXBMbXZtZVY1TmtMelMyQT09IiwibWFjIjoiZmE4YzBlZDJhZTJlZGEyZTQ4ZWNjMmUwZTc2ZmVhN2ZjYTljOTVhNDFmNjM4N2QxMjdmNWM2MjU5Yjk3ODhjNiIsInRhZyI6IiJ9', '2026-04-07 09:39:49', NULL, NULL, 'active', NULL, NULL, '2026-04-07 09:39:49', '2026-04-07 15:26:06'),
(12, 'Employee', 'employee@vnb.id', NULL, '$2y$12$nNsVbvuPopVciFABSrI6POTqwGoG5Cn4I5pVdUM3T/4z1gn9FNeU2', 'eyJpdiI6IklLZjFBbC9TL3VMUnp4TkVkWCttdHc9PSIsInZhbHVlIjoibmx0STE3Nzl5dkYzQXd2bWpidDlRZz09IiwibWFjIjoiZGE2NzUxMWMwZmNjOWU2MDQ0NjY0Nzc0YjJmODg5OTJmNTQ3YzZjNDJmOTc5N2ZiN2EzNGMzMDcxMjYzNjdkYiIsInRhZyI6IiJ9', '2026-04-07 09:40:31', '082123456789', NULL, 'active', 1, NULL, '2026-04-07 09:40:31', '2026-04-07 09:56:38'),
...
(1, 'manage_self_non_staff', 'Empathy', '1-3', 'Memberikan apresiasi tertulis kepada rekan-rekan kerjanya', 'Bertanya kepada rekan satu tim tentang tantangan atau kesulitan yang mereka hadapi, memberikan saran atau membantu mereka sesuai dengan wewenang dan tanggung jawab', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(2, 'manage_self_non_staff', 'Empathy', '4-6', 'Inisiatif Menawarkan bantuan pada rekan kerja yang membutuhkan bantuan sesuai dengan ranahnya', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(3, 'manage_self_non_staff', 'Empathy', '6+', 'Membantu mengenalkan cara kerja ke rekan baru', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
...
(5, 'manage_self_non_staff', 'Be A Wismilak Ambassador', '4-6', 'Mengikuti aktivitas-aktivitas Wismilak', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(6, 'manage_self_non_staff', 'Be A Wismilak Ambassador', '6+', 'Menjadi contoh kedisiplinan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(7, 'manage_self_non_staff', 'Effective & Efficient', '1-3', 'Mengetahui ranah pekerjaannya sesuai job desc dan visi misi perusahaan', 'Mengikuti pelatihan penggunaan alat kerja/SOP yang benar dan membuat laporan singkat pemahaman', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(8, 'manage_self_non_staff', 'Effective & Efficient', '4-6', 'Disiplin Bekerja sesuai dengan target perusahaan (waktu dan materi)', 'Mengusulkan ide-ide (>1) untuk menyederhanakan pekerjaan harian atau sistem kerja & standarisasi', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(9, 'manage_self_non_staff', 'Effective & Efficient', '6+', 'Menghindari melakukan kesalahan berulang. Dan dapat Mengingatkan rekan jika kerja tidak sesuai SOP', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(10, 'manage_self_non_staff', 'Speak with Data', '1-3', 'Melaporkan hasil kerja sesuai jumlah nyata', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(11, 'manage_self_non_staff', 'Speak with Data', '4-6', 'Mengakui kesalahan tanpa ditutup-tutupi', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(12, 'manage_self_non_staff', 'Speak with Data', '6+', 'Menyampaikan jika hasil turun & cari penyebab', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(13, 'manage_self_non_staff', 'Collaborative', '1-3', 'Mengetahui peran tim yang terlibat dalam pekerja hariannya', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(14, 'manage_self_non_staff', 'Collaborative', '4-6', 'Saling membantu / back up rekan kerja ketika dibutuhkan untuk mencapai target perusahaan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(15, 'manage_self_non_staff', 'Collaborative', '6+', 'Menjaga suasana kerja kondusif (Hal apa saja yang dapat dilakukan untuk mencapai hal ini)', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(16, 'manage_self_non_staff', 'Decisive', '1-3', 'Langsung melapor jika ada kendala---Mengajukan solusi untuk penyelesaian masalah dalam pekerjaan harian, kemudian konsultasikan kepada atasan sebelum dilakukan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(17, 'manage_self_non_staff', 'Decisive', '4-6', 'Tidak membiarkan kesalahan berulang --- Menyampaikan kepada atasan peluang atau masalah (loophole) yang dapat berdampak ke departemen, divisi, atau perusahaan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(18, 'manage_self_non_staff', 'Decisive', '6+', 'Memberi saran sederhana jika lihat potensi masalah', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(19, 'manage_self_non_staff', 'Open Mind', '1-3', 'Meminta dan memberikan 1 feedback dari atasan, rekan kerja, atau team dan menerapkannya.', 'Menyampaikan hambatan yang dialami kepada Atasan dan menyusun Action Plan untuk mengatasinya', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(20, 'manage_self_non_staff', 'Open Mind', '4-6', 'Mengetahui kelebihan dan kekurangan yang dimiliki selama bekerja, dan dipersilahkan mengajukan pelatihan apabila diperlukan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(21, 'manage_self_non_staff', 'Open Mind', '6+', 'Berani menyampaikan ide unik/kreatif (tanpa takut salah) kepada atasan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(22, 'manage_self_staff', 'Empathy', '1-3', 'Memberikan apresiasi tertulis kepada rekan-rekan kerjanya', 'Bertanya kepada rekan satu tim tentang tantangan atau kesulitan yang mereka hadapi, memberikan saran atau membantu mereka sesuai dengan wewenang dan tanggung jawab', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(23, 'manage_self_staff', 'Empathy', '4-6', 'Menginisiasi diskusi dengan rekan berbeda divisi / departemen (klien internal) atau klien eksternal untuk memahami tantangan dan membantu mereka sesuai dengan wewenang dan tanggung jawab', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(24, 'manage_self_staff', 'Empathy', '6+', 'Karyawan ditugaskan menjadi \"buddy\" untuk rekan baru atau rekan satu tim dalam project tertentu', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
...
(26, 'manage_self_staff', 'Be A Wismilak Ambassador', '4-6', 'Mengikuti aktivitas-aktivitas Wismilak', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(27, 'manage_self_staff', 'Be A Wismilak Ambassador', '6+', 'Menjadi panitia, pelaksana, atau koordinator dalam minimal 1 event perusahaan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(28, 'manage_self_staff', 'Effective & Efficient', '1-3', 'Mengisi template \"Visi & Misi Alignment Map\": mencocokkan pekerjaan harian dengan kontribusinya terhadap visi & misi perusahaan', 'Mengikuti pelatihan penggunaan alat kerja / SOP yang benar dan membuat laporan ringkas pemahaman', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(29, 'manage_self_staff', 'Effective & Efficient', '4-6', 'Membuat pertimbangan cost vs benefit perusahaan dari pekerjaan yang dilakukan', 'Mengusulkan ide-ide (>1) untuk menyederhanakan pekerjaan harian atau sistem kerja & standarisasi', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(30, 'manage_self_staff', 'Effective & Efficient', '6+', 'Melatih 1 rekan kerja tentang tips kerja efisien yang sudah ter-standard', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(31, 'manage_self_staff', 'Speak with Data', '1-3', 'Belajar membaca atau memahami minimal 1 jenis data dasar yang digunakan di divisinya (misalnya: output, volume, target)', 'Mencatat minimal 1 hal yang bisa diukur dari pekerjaannya dan melacak progresnya', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(32, 'manage_self_staff', 'Speak with Data', '4-6', 'Menyusun target kerja (Specific, Measurable, Achievable, Reachable, Time bound) berdasarkan data yang dikumpulkan', 'Menyusun dan presentasi laporan berbasis data dari pekerjaan yang dilakukan', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(33, 'manage_self_staff', 'Speak with Data', '6+', 'Memberikan usulan pada proses kerja berdasarkan data yang dipresentasikan dan menunjukkan progress.', 'Studi kasus: membedakan mana data atau informasi milik Divisi dan Perusahaan yang boleh dan tidak boleh disebarluaskan', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(34, 'manage_self_staff', 'Collaborative', '1-3', 'Identifikasi impact pekerjaan karyawan pada bagian, departemen atau divisi lain (user) untuk mengenal peran mereka dan sebaliknya', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(35, 'manage_self_staff', 'Collaborative', '4-6', 'Ikut serta dalam 1 kegiatan atau project tim lintas fungsi', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(36, 'manage_self_staff', 'Collaborative', '6+', 'Mengusulkan dan menjadi koordinator kolaborasi baru yang bisa menguntungkan dua tim/departemen/divisi', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(37, 'manage_self_staff', 'Decisive', '1-3', 'Mengajukan solusi untuk penyelesaian masalah dalam pekerjaan harian, kemudian konsultasikan kepada atasan sebelum dilakukan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(38, 'manage_self_staff', 'Decisive', '4-6', 'Menyampaikan kepada atasan peluang atau masalah (loophole) yang dapat berdampak ke departemen, divisi, atau perusahaan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(39, 'manage_self_staff', 'Decisive', '6+', 'Memberi usulan strategis kepada atasan yang berdampak pada sistem/proses ke depan dan lanjutkan dengan PDCA (Plan , Do, Check, Action)', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(40, 'manage_self_staff', 'Open Mind', '1-3', 'Meminta dan memberikan 1 feedback dari atasan, rekan kerja, atau team dan menerapkannya.', 'Menyampaikan hambatan yang dialami kepada Atasan dan menyusun Action Plan untuk mengatasinya', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(41, 'manage_self_staff', 'Open Mind', '4-6', 'Membuat list Strength, Area for Development, dan mengikuti pelatihan yang sesuai', 'Menjadi fasilitator atau moderator dalam sesi diskusi untuk integrasi berbagai ide', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(42, 'manage_self_staff', 'Open Mind', '6+', 'Menyampaikan ide unik/kreatif (tanpa takut salah) kepada atasan, lalu menilai bersama potensi pengembangannya.', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
...
(44, 'manage_others', 'Be A Wismilak Ambassador', '4-6', 'Mengikuti aktivitas-aktivitas Wismilak', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(45, 'manage_others', 'Be A Wismilak Ambassador', '6+', 'Menjadi panitia, pelaksana, atau koordinator dalam minimal 1 event perusahaan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(46, 'manage_others', 'Collaborative', '1-3', 'Identifikasi impact pekerjaan karyawan pada bagian, departemen atau divisi lain (user) untuk mengenal peran mereka dan sebaliknya', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(47, 'manage_others', 'Collaborative', '4-6', 'Ikut serta dalam 1 kegiatan atau project tim lintas fungsi', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(48, 'manage_others', 'Collaborative', '6+', 'Mengusulkan dan menjadi koordinator kolaborasi baru yang bisa menguntungkan dua tim/departemen/divisi', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(49, 'manage_others', 'Decisive', '1-3', 'Mengajukan solusi untuk penyelesaian masalah dalam pekerjaan harian, kemudian konsultasikan kepada atasan sebelum dilakukan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(50, 'manage_others', 'Decisive', '4-6', 'Menyampaikan kepada atasan peluang atau masalah (loophole) yang dapat berdampak ke departemen, divisi, atau perusahaan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(51, 'manage_others', 'Decisive', '6+', 'Memberi usulan strategis kepada atasan yang berdampak pada sistem/proses ke depan dan lanjutkan dengan PDCA (Plan , Do, Check, Action)', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(52, 'manage_others', 'Effective & Efficient', '1-3', 'Mengisi template \"Visi & Misi Alignment Map\": mencocokkan pekerjaan harian dengan kontribusinya terhadap visi & misi perusahaan', 'Mengikuti pelatihan penggunaan alat kerja / SOP yang benar dan membuat laporan ringkas pemahaman', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(53, 'manage_others', 'Effective & Efficient', '4-6', 'Membuat pertimbangan cost vs benefit perusahaan dari pekerjaan yang dilakukan', 'Mengusulkan ide-ide (>1) untuk menyederhanakan pekerjaan harian atau sistem kerja & standarisasi', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(54, 'manage_others', 'Effective & Efficient', '6+', 'Melatih 1 rekan kerja tentang tips kerja efisien yang sudah ter-standard', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(55, 'manage_others', 'Empathy', '1-3', 'Memberikan apresiasi tertulis kepada rekan-rekan kerjanya', 'Bertanya kepada rekan satu tim tentang tantangan atau kesulitan yang mereka hadapi, memberikan saran atau membantu mereka sesuai dengan wewenang dan tanggung jawab', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(56, 'manage_others', 'Empathy', '4-6', 'Menginisiasi diskusi dengan rekan berbeda divisi / departemen (klien internal) atau klien eksternal untuk memahami tantangan dan membantu mereka sesuai dengan wewenang dan tanggung jawab', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(57, 'manage_others', 'Empathy', '6+', 'Karyawan ditugaskan menjadi \"buddy\" untuk rekan baru atau rekan satu tim dalam project tertentu', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(58, 'manage_others', 'Open Mind', '1-3', 'Meminta dan memberikan 1 feedback dari atasan, rekan kerja, atau team dan menerapkannya.', 'Menyampaikan hambatan yang dialami kepada Atasan dan menyusun Action Plan untuk mengatasinya', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(59, 'manage_others', 'Open Mind', '4-6', 'Membuat list Strength, Area for Development, dan mengikuti pelatihan yang sesuai', 'Menjadi fasilitator atau moderator dalam sesi diskusi untuk integrasi berbagai ide', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(60, 'manage_others', 'Open Mind', '6+', 'Menyampaikan ide unik/kreatif (tanpa takut salah) kepada atasan, lalu menilai bersama potensi pengembangannya.', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(61, 'manage_others', 'Speak with Data', '1-3', 'Belajar membaca atau memahami minimal 1 jenis data dasar yang digunakan di divisinya (misalnya: output, volume, target)', 'Mencatat minimal 1 hal yang bisa diukur dari pekerjaannya dan melacak progresnya', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(62, 'manage_others', 'Speak with Data', '4-6', 'Menyusun target kerja (Specific, Measurable, Achievable, Reachable, Time bound) berdasarkan data yang dikumpulkan', 'Menyusun dan presentasi laporan berbasis data dari pekerjaan yang dilakukan', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(63, 'manage_others', 'Speak with Data', '6+', 'Memberikan usulan pada proses kerja berdasarkan data yang dipresentasikan dan menunjukkan progress.', 'Studi kasus: membedakan mana data atau informasi milik Divisi dan Perusahaan yang boleh dan tidak boleh disebarluaskan', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
...
(65, 'manage_managers', 'Be A Wismilak Ambassador', '4-6', 'Mengikuti aktivitas-aktivitas Wismilak', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(66, 'manage_managers', 'Be A Wismilak Ambassador', '6+', 'Menjadi panitia, pelaksana, atau koordinator dalam minimal 1 event perusahaan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(67, 'manage_managers', 'Collaborative', '1-3', 'Identifikasi impact pekerjaan karyawan pada bagian, departemen atau divisi lain (user) untuk mengenal peran mereka dan sebaliknya', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(68, 'manage_managers', 'Collaborative', '4-6', 'Ikut serta dalam 1 kegiatan atau project tim lintas fungsi', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(69, 'manage_managers', 'Collaborative', '6+', 'Mengusulkan dan menjadi koordinator kolaborasi baru yang bisa menguntungkan dua tim/departemen/divisi', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(70, 'manage_managers', 'Decisive', '1-3', 'Mengajukan solusi untuk penyelesaian masalah dalam pekerjaan harian, kemudian konsultasikan kepada atasan sebelum dilakukan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(71, 'manage_managers', 'Decisive', '4-6', 'Menyampaikan kepada atasan peluang atau masalah (loophole) yang dapat berdampak ke departemen, divisi, atau perusahaan', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(72, 'manage_managers', 'Decisive', '6+', 'Memberi usulan strategis kepada atasan yang berdampak pada sistem/proses ke depan dan lanjutkan dengan PDCA (Plan , Do, Check, Action)', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(73, 'manage_managers', 'Effective & Efficient', '1-3', 'Mengisi template \"Visi & Misi Alignment Map\": mencocokkan pekerjaan harian dengan kontribusinya terhadap visi & misi perusahaan', 'Mengikuti pelatihan penggunaan alat kerja / SOP yang benar dan membuat laporan ringkas pemahaman', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(74, 'manage_managers', 'Effective & Efficient', '4-6', 'Membuat pertimbangan cost vs benefit perusahaan dari pekerjaan yang dilakukan', 'Mengusulkan ide-ide (>1) untuk menyederhanakan pekerjaan harian atau sistem kerja & standarisasi', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(75, 'manage_managers', 'Effective & Efficient', '6+', 'Melatih 1 rekan kerja tentang tips kerja efisien yang sudah ter-standard', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(76, 'manage_managers', 'Empathy', '1-3', 'Memberikan apresiasi tertulis kepada rekan-rekan kerjanya', 'Bertanya kepada rekan satu tim tentang tantangan atau kesulitan yang mereka hadapi, memberikan saran atau membantu mereka sesuai dengan wewenang dan tanggung jawab', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(77, 'manage_managers', 'Empathy', '4-6', 'Menginisiasi diskusi dengan rekan berbeda divisi / departemen (klien internal) atau klien eksternal untuk memahami tantangan dan membantu mereka sesuai dengan wewenang dan tanggung jawab', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(78, 'manage_managers', 'Empathy', '6+', 'Karyawan ditugaskan menjadi \"buddy\" untuk rekan baru atau rekan satu tim dalam project tertentu', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(79, 'manage_managers', 'Open Mind', '1-3', 'Meminta dan memberikan 1 feedback dari atasan, rekan kerja, atau team dan menerapkannya.', 'Menyampaikan hambatan yang dialami kepada Atasan dan menyusun Action Plan untuk mengatasinya', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(80, 'manage_managers', 'Open Mind', '4-6', 'Membuat list Strength, Area for Development, dan mengikuti pelatihan yang sesuai', 'Menjadi fasilitator atau moderator dalam sesi diskusi untuk integrasi berbagai ide', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(81, 'manage_managers', 'Open Mind', '6+', 'Menyampaikan ide unik/kreatif (tanpa takut salah) kepada atasan, lalu menilai bersama potensi pengembangannya.', NULL, '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(82, 'manage_managers', 'Speak with Data', '1-3', 'Belajar membaca atau memahami minimal 1 jenis data dasar yang digunakan di divisinya (misalnya: output, volume, target)', 'Mencatat minimal 1 hal yang bisa diukur dari pekerjaannya dan melacak progresnya', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(83, 'manage_managers', 'Speak with Data', '4-6', 'Menyusun target kerja (Specific, Measurable, Achievable, Reachable, Time bound) berdasarkan data yang dikumpulkan', 'Menyusun dan presentasi laporan berbasis data dari pekerjaan yang dilakukan', '2026-04-07 09:53:10', '2026-04-07 09:53:10'),
(84, 'manage_managers', 'Speak with Data', '6+', 'Memberikan usulan pada proses kerja berdasarkan data yang dipresentasikan dan menunjukkan progress.', 'Studi kasus: membedakan mana data atau informasi milik Divisi dan Perusahaan yang boleh dan tidak boleh disebarluaskan', '2026-04-07 09:53:10', '2026-04-07 09:53:10');
...
(1, 1, 4, 1, 'Rencana VnB - Employee', 'Auto-generated dari framework manage_self_staff', 'adjust_all', 'draft', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-07 09:56:14', '2026-04-07 09:56:14'),
