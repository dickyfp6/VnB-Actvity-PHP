...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('star_recognition_responses', function (Blueprint $table) {
            $table->id();
            $table->foreignId('star_recognition_id')->constrained('star_recognitions')->cascadeOnDelete();
            $table->foreignId('star_schema_indicator_id')->constrained('star_schema_indicators')->cascadeOnDelete();
            $table->foreignId('star_schema_indicator_option_id')->constrained('star_schema_indicator_options')->cascadeOnDelete();
